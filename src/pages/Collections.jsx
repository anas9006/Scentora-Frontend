  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 luxury-gradient">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-center gap-3 text-sm uppercase tracking-[0.4em] text-secondary mb-4">
            <span className="h-0.5 w-12 bg-secondary rounded-full"></span>
            Explore Our World
            <span className="h-0.5 w-12 bg-secondary rounded-full"></span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold gold-text gold-glow mb-6">Exquisite Collections</h1>
            ...
            {categories.map((category, index) => (
              ...
              >
                <Link to={`/shop?category=${category.slug}`} className="block">
                  <div className="surface-panel rounded-[2.5rem] overflow-hidden border border-secondary/10 group-hover:border-secondary/40 transition-all duration-500">
